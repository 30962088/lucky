...
import com.mengle.lucky.network.UserGameCreatorRequest;
...
public class UserGameCreatorFragment extends Fragment implements OnLoadListener,OnClickListener{
	...
	public static UserGameCreatorFragment newInstance(int uid){
		Bundle args = new Bundle();
		args.putInt("uid", uid);
		UserGameCreatorFragment fragment = new UserGameCreatorFragment();
		fragment.setArguments(args);
		return fragment;
	}
	
	public UserGameCreatorFragment() {
	...
	public void onLoadSuccess() {
		...
		if(offset == 0&&list.size() == 1){
			...
			if(user.getUid() == uid){
				...
				SpannableString spanableInfo = new SpannableString("您目前没有发起任何竞猜，快去试试吧！");
				spanableInfo.setSpan(textClickable,14, 16,Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
