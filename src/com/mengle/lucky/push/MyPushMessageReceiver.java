...
public class MyPushMessageReceiver extends FrontiaPushMessageReceiver {
	...
	public void onBind(Context context, int errorCode, String appid,
		...
		if (errorCode == 0) {
			Preferences.Push push = new Push(context);
	...
	public void onMessage(Context context, String message,
		...
		if (!TextUtils.isEmpty(message)) {
			...
			try {
				customJson = new JSONObject(message).getJSONObject("custom_content");
				if(customJson.has("kick")){
					int kick = customJson.getInt("kick");
					if(kick==1){
						Preferences.User user = new Preferences.User(context);
						user.logout();
						Preferences.Push push = new Preferences.Push(context);
						push.setLogout(true);
